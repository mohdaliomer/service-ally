...
const statusStyles: Record<string, string> = {
  ...
  // External
  'External-Pending-RM': 'bg-violet-500/15 text-violet-600',
  'External-Pending-MC-QC': 'bg-cyan-500/15 text-cyan-600',
  'External-Pending-MM': 'bg-orange-500/15 text-orange-600',
  'External-Pending-Admin': 'bg-purple-500/15 text-purple-600',
  'External-Pending-MC-2': 'bg-cyan-500/15 text-cyan-600',
  'External-Pending-MM-2': 'bg-orange-500/15 text-orange-600',
...
const statusLabels: Record<string, string> = {
  ...
  'External-Pending-MC-QC': 'Pending Quality Check',
  'External-Pending-MM': 'Pending Maint. Manager',
  'External-Pending-Admin': 'Pending Admin Manager',
  'External-Pending-MC-2': 'Pending Coordinator',
  'External-Pending-MM-2': 'Pending Maint. Manager',
